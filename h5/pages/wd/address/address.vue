<template>
  <page-body>
    <view class="page">
      <view class="flex align-stretch benben-position-layout flex address_flex_0_babdd"
        :style="{ height: 88 + StatusBarRpx + 'rpx', paddingTop: StatusBarRpx + 'rpx' }">
        <view class="flex align-center justify-between flex-sub address_fd0_0_babdd">
          <view class="flex align-center address_fd0_0_c0_babdd" @tap.stop="handleJumpDiy" data-type="back"
            data-url="1">
          ...
          <view class="flex align-center address_fd0_0_c0_babdd"></view>
        </view>
      </view>
      ...
      <view class="flex flex-direction align-stretch benben-flex-layout address_flex_1_babdd">
        <template v-for="(item, key0) in dataList">
          <view class="flex flex-direction align-stretch address_fd1_0_babdd" @tap.stop="handleClickFunc(item.aid)"
            :key="key0">
            <view class="flex flex-direction align-stretch">
              <view class="flex flex-wrap align-center address_fd1_0_c0_c0_babdd">
                <view class="flex flex-wrap align-center address_fd1_0_c0_c0_c0_babdd" v-if="item.label_name">
                ...
                <text class="address_fd1_0_c0_c0_c2_babdd" v-if="item.sex == '1'">{{ $t('先生') }}</text>
                <text class="address_fd1_0_c0_c0_c2_babdd" v-if="item.sex != '1'">{{ $t('女士') }}</text>
                <text class="address_fd1_0_c0_c0_c2_babdd">)</text>
              ...
              <view class="flex align-center justify-between address_fd1_0_c0_c2_babdd">
                <view class="flex flex-wrap align-center" @tap.stop="SelectDefaultFunc(item.aid, item.is_default)">
                  <text class="fu-iconfont2 address_fd1_0_c0_c2_c0_c0_babdd"
                    v-if="item.is_default == '1'">&#xe847;</text>
                  <text class="fu-iconfont2 address_fd1_0_c0_c2_c0_c0_1_babdd"
                    v-if="item.is_default == 0">&#xe764;</text>
                ...
                <view class="flex flex-wrap align-center">
                  ...
                  <view class="flex flex-wrap align-center address_fd1_0_c0_c2_c1_c1_babdd" @tap.stop="handleJumpDiy"
                    data-type="navigateTo" :data-url="`/pages/wd/editAddress/editAddress?id=${item.aid}`">
                    <text class="fu-iconfont2 address_fd1_0_c0_c2_c1_c0_c0_babdd">&#xe608;</text>
        ...
        <view class="flex flex-wrap align-center justify-center address_fd1_1_babdd">
          <button class="address_fd1_1_c0_babdd" @tap.stop="handleJumpDiy" data-type="navigateTo"
...
<style lang="scss" scoped>
  .page {
    ...
    .address_flex_1_babdd {
      ...
      border-top: 1px solid var(--benbenbdColor0);
      padding: 12rpx 0rpx 150rpx 0rpx;
