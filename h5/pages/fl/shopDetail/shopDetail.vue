<template>
  <page-body>
    <view class="page">
      <view class="flex flex-wrap align-center justify-between benben-position-layout flex shopDetail_flex_0_babdd"
        ...
        <view class="flex flex-wrap align-center justify-end shopDetail_fd0_0_babdd"
          :style="{ 'margin-right': `${appSystemIdentification == 'Wechat' ? '30%' : ''}` }">
          <image class="shopDetail_fd0_1_c0_babdd" mode="aspectFit" :src="STATIC_URL + '70.png'"
            @tap.stop="popupShow1689239427011 = true" v-if="appSystemIdentification != 'Wechat'"></image>
        </view>
      </view>
      <benben-specs-popup ref="specsPopup1706585747219" class="shopDetail_flex_specs_1_babdd" price-name="shop_price"
        ...
        :stock.sync="dataDetails.stock" :number.sync="buy_num" @addCart="addCarFunc()"
        @buyNow="buyNowFunc()"></benben-specs-popup>
      <!---flex布局flex布局开始-->
        ...
        <view class="flex align-center shopDetail_fd2_0_babdd">
          <view style="position: relative">
            <swiper ref="benbenSwiperfd2_0_c0" :current="index" @change="bannerIndexfd2_0_c0 = $event.detail.current"
              class="flex position-relative shopDetail_fd2_0_c0_babdd" previous-margin="0rpx" next-margin="0rpx"
              ...
              <swiper-item class="flex shopDetail_fd2_0_c0_babdd" v-if="dataDetails.video != ''">
                <view class="flex align-center self-center justify-center shopDetail_fd2_0_c0_c1_c0_babdd"
                  @tap.stop="videoplayerFunc(dataDetails.video)">
                  <image class="shopDetail_fd2_0_c0_c1_c0_c0_babdd" mode="aspectFill" :src="dataDetails.video_img">
                  </image>
                  <image class="shopDetail_fd2_0_c0_c1_c0_c1_babdd" mode="aspectFit" :src="STATIC_URL + '84.png'">
                  </image>
                </view>
              </swiper-item>
              ...
              <template v-for="(item, key0) in dataDetails.images">
                <swiper-item class="flex" :key="key0">
                  <image class="shopDetail_fd2_0_c0_c1_c0_c0_babdd" mode="aspectFill" :src="item"
                    @tap="multiImagePreview(item, dataDetails.images, '')"></image>
                </swiper-item>
              </template>
            </swiper>
            <view style="position: absolute"
              class="flex dot flex align-center justify-center shopDetail_swiperDotfd2_0_c0_babdd">
              <view class="flex flex align-center justify-center shopDetail_numberfd2_0_c0_c0_babdd">
                ...
                <text
                  class="shopDetail_numberfd2_0_c0_c0_c0_babdd">{{ dataDetails.images.length + (dataDetails.video ? 1 : 0) }}</text>
              </view>
            </view>
          </view>
        </view>
      ...
      <!---flex布局flex布局结束-->
      <l-painter :css="{ width: `700rpx`, height: `750rpx`, background: `#FFF` }" ref="painter1730449491555"
 ...
 -->
          <l-painter-image
            ...
            :src="wxShareImg.base64"></l-painter-image>
          <l-painter-text :css="{
              position: `absolute`,
              top: `74rpx`,
              left: `122rpx`,
          ...
          <l-painter-text
            ...
            :text="$t('推荐一个好物给你，请查收')"></l-painter-text>
          <l-painter-image
      ...
      <l-painter :css="{ width: `580rpx`, height: `924rpx`, background: `#FFF`, backgroundSize: `100% auto` }"
        ref="painter1690420071407" :hidden="true" file-type="png" path-type="url">
        <template v-if="painterParam1690420071407">
          <l-painter-image :css="{ width: `580rpx`, height: `148rpx`, position: `absolute`, top: `0rpx`, left: `0rpx` }"
            :src="STATIC_URL + '822.png'"></l-painter-image>
          ...
          <l-painter-text :css="{ position: `absolute`, top: `752rpx`, left: `30rpx`, width: `NaNrpx` }"
            :text="'￥'"></l-painter-text>
          <l-painter-text :css="{ position: `absolute`, top: `812rpx`, left: `30rpx`, width: `362rpx`, lineClamp: `2` }"
            :text="dataDetails.name"></l-painter-text>
        </template>
      </l-painter>
      <benben-popup v-model="popupShow1700556466468" :mask="true" :mask-close-able="true" mode="bottom" :z-index="999">
        ...
        <view class="flex flex-direction align-stretch benben-flex-layout shopDetail_flex_5_babdd">
          <view class="flex flex-wrap align-center justify-between shopDetail_fd5_0_babdd">
            ...
            <image class="shopDetail_fd5_0_c2_babdd" mode="aspectFit" :src="STATIC_URL + '93.png'"
              @tap.stop="popupShow1700556466468 = false"></image>
          </view>

          <scroll-view class="shopDetail_fd5_1_babdd" :scroll-x="false" :scroll-y="true" :show-scrollbar="false"
            v-if="dataDetails.package_arr.length > 0" :enhanced="true">
            <view class="flex flex-direction align-stretch benben-scroll flex">
              <template v-for="(item, key0) in dataDetails.package_arr">
                <view class="flex flex-direction align-stretch shopDetail_fd5_1_c0_babdd" v-if="item.type == '1'"
                  :key="key0">
                  <view class="flex align-center justify-between">
                    <view class="flex flex-wrap align-center shopDetail_fd5_1_c0_c0_c0_babdd">
                      <image class="shopDetail_fd5_1_c0_c0_c0_c0_babdd" mode="aspectFit" :src="STATIC_URL + '66.png'">
                      </image>
                      <text>{{ $t('套餐') }}</text>
                      <text>{{ key0 + 1 }}</text>
                      <text>：</text>
                        ...
                        <view class="flex flex-wrap align-center shopDetail_fd5_1_c0_c1_c1_c2_babdd">
                          <view class="flex flex-wrap align-center shopDetail_fd5_1_c0_c1_c1_c2_c0_babdd">
                            ...
                            <text class="shopDetail_fd5_1_c0_c1_c1_c2_c0_c1_babdd">
                              <text
                                class="shopDetail_price1_fd5_1_c0_c0_c1_c1_babdd">{{ child.price | frontPrice }}</text>
                              <text
                                class="shopDetail_price1_fd5_1_c0_c0_c1_c1_babdd">{{ child.price | laterPrice }}</text>
                            </text>
                          </view>
                          <view class="flex flex-wrap align-center shopDetail_fd5_1_c0_c1_c1_c2_c1_babdd">
                            ...
                            <text class="shopDetail_fd5_1_c0_c1_c1_c2_c1_c1_babdd">
                              <text
                                class="shopDetail_price1_fd5_1_c0_c0_c1_c1_babdd">{{ child.shop_price | frontPrice }}</text>
                              <text
                                class="shopDetail_price1_fd5_1_c0_c0_c1_c1_babdd">{{ child.shop_price | laterPrice }}</text>
                            </text>
                          </view>
                        </view>
                      </view>
                  ...
                  <view class="flex align-center justify-center shopDetail_fd5_1_c0_c2_babdd">
                    <view class="flex align-center justify-center shopDetail_fd5_1_c0_c2_c0_babdd"
                      @tap.stop="PurchasePackageFunc(item)">
                      <text>{{ $t('购买此套餐') }}</text>
              ...
              <template v-for="(item, key0) in dataDetails.package_arr">
                <view class="flex flex-direction align-stretch shopDetail_fd5_1_c0_babdd" v-if="item.type == '2'"
                  :key="key0">
                  <view class="flex align-center justify-between">
                  ...
                  <template v-for="(child, key1) in item.info">
                    <view class="flex align-stretch shopDetail_fd5_1_c0_c1_babdd" v-if="key1 == 0" :key="key1">
                      <image class="shopDetail_fd5_1_c1_c1_c0_babdd" mode="aspectFit" :src="STATIC_URL + '106.png'">
                      </image>
                      <image class="shopDetail_fd5_1_c0_c1_c0_babdd" mode="aspectFit" :src="child.goods_thumb"></image>
                      <view class="flex flex-direction align-stretch flex-sub">
                  ...
                  <template v-for="(child, key1) in item.info">
                    <view class="flex align-stretch shopDetail_fd5_1_c0_c1_babdd" v-if="key1 > 0" :key="key1">
                      <image class="shopDetail_fd5_1_c1_c1_c0_babdd" mode="aspectFit" :src="STATIC_URL + '6.png'">
                      </image>
                      <image class="shopDetail_fd5_1_c0_c1_c0_babdd" mode="aspectFit" :src="child.goods_thumb"></image>
                      <view class="flex flex-direction align-stretch flex-sub">
                  ...
                  <view class="flex align-center justify-center shopDetail_fd5_1_c0_c2_babdd">
                    <view class="flex align-center justify-center shopDetail_fd5_1_c1_c3_c0_babdd"
                      @tap.stop="PurchasePackageFunc(item)">
                      <text>{{ $t('购买此套餐') }}</text>
                      <text>{{ item.count }}</text>
                      <text>{{ $t('件商品') }}</text>
 ...
 -->
        <view class="flex flex-direction flex-wrap align-stretch shopDetail_fd6_3_babdd">
          <view class="flex flex-wrap align-center">
            ...
            <view class="flex flex-direction flex-wrap align-center justify-center shopDetail_fd6_3_c0_c1_babdd"
              @tap.stop="isLikeFunc()">
              <image class="shopDetail_fd6_3_c0_c1_c0_babdd" mode="aspectFit" :src="STATIC_URL + '72.png'"
                v-if="dataDetails.is_collect == '0'"></image>
              <image class="shopDetail_fd6_3_c0_c1_c0_babdd" mode="aspectFit" :src="STATIC_URL + '407.png'"
                v-if="dataDetails.is_collect == '1'"></image>
              <text class="shopDetail_fd6_3_c0_c1_c1_babdd" v-if="dataDetails.is_collect == '0'">{{ $t('收藏') }}</text>
              <text class="shopDetail_fd6_3_c0_c1_c1_1_babdd"
                v-if="dataDetails.is_collect == '1'">{{ $t('已收藏') }}</text>
            </view>
            <view class="flex flex-direction flex-wrap align-center" @tap.stop="popupShow1689239427011 = true"
          ...
          <view class="flex align-center shopDetail_fd6_3_c1_babdd" @tap.stop="popupShow1679630010186 = true"
            v-if="dataDetails.coupon_list.length != '0'">
            <scroll-view class="shopDetail_fd6_3_c1_c0_babdd" :scroll-x="true" :scroll-y="false" :show-scrollbar="false"
              :enhanced="true">
              <view class="flex align-stretch benben-scroll flex">
                <template v-for="(item, key0) in dataDetails.coupon_list">
                  <view class="flex flex-wrap align-center shopDetail_fd6_3_c1_c0_c0_babdd" v-if="key0 < '2'"
                    :key="key0">
                    <text class="shopDetail_fd6_3_c1_c0_c0_c0_babdd"
                      v-if="item.content == '全场可用'">{{ $t('通用｜') }}</text>
...
<text class='shopDetail_fd6_4_c1_c0_c1_babdd'  >{{$t('50件')}}</text>
 ...
 -->
      ...
      <!---flex布局flex布局结束-->
      <benben-specs-popup ref="specsPopup1700719656688" class="shopDetail_flex_specs_7_babdd" price-name="shop_price"
        @confirm="ConfirmPackagePopupFunc()"></benben-specs-popup>
      <!---flex布局flex布局开始-->
      <view class="flex flex-direction align-stretch benben-flex-layout">
        <view class="flex flex-direction flex-wrap align-stretch shopDetail_fd8_0_babdd">
          ...
          <view class="flex flex-wrap align-center" @tap.stop="isAddressFunc()">
            ...
            <view class="flex align-center flex-sub shopDetail_fd8_0_c0_c1_babdd">
              <view class="flex flex-wrap align-center shopDetail_fd8_0_c1_c1_c0_babdd">
                <image class="shopDetail_fd8_0_c1_c1_c0_c0_babdd" mode="aspectFit" :src="STATIC_URL + '113.png'"
          ...
          <view class="flex flex-wrap align-center" @tap.stop="popupShow1665473180775 = true">
            ...
            <view class="flex flex-wrap align-center justify-end flex-sub shopDetail_fd8_0_c0_c1_babdd">
              ...
              <text class="shopDetail_fd8_0_c2_c1_c0_1_babdd"
                v-if="dataDetails.is_shipping == '0'">{{ dataDetails.freight_name }}</text>
              <image class="shopDetail_fd8_0_c0_c1_c2_babdd" mode="aspectFit" :src="STATIC_URL + '304.png'"></image>
            </view>
          </view>
          <view class="flex flex-wrap align-center shopDetail_fd8_0_c3_babdd" @tap.stop="popupShow1679637574316 = true"
      ...
      <view class="flex flex-direction align-stretch benben-flex-layout">
        <view class="flex flex-direction flex-wrap align-stretch shopDetail_fd9_0_babdd">
          <view class="flex flex-wrap align-center flex-sub shopDetail_fd9_0_c0_babdd" @tap.stop="handleJumpDiy"
            ...
            <text class="shopDetail_fd9_0_c0_c5_babdd"
              v-if="dataDetails.comment_total > 0">{{ dataDetails.praise_rate }}</text>
          ...
          <template v-for="(item, key0) in dataDetails.comment">
            <view class="flex flex-direction flex-wrap align-stretch flex-sub shopDetail_fd9_0_c1_babdd"
                ...
                <view class="flex flex-direction flex-wrap align-stretch flex-sub shopDetail_fd9_0_c1_c0_c1_babdd">
                  ...
                  <view class="flex flex-wrap align-center">
                    <template v-for="starNum in [1, 2, 3, 4, 5]">
                      <image v-if="item.star >= starNum" :key="starNum" class="shopDetail_star1fd9_0_c1_c0_c1_c1_babdd"
                        mode="aspectFit" :src="STATIC_URL + '428.png'"></image>
                      <image v-else :key="starNum" class="shopDetail_star1fd9_0_c1_c0_c1_c1_babdd" mode="aspectFit"
              ...
              <view class="flex flex-wrap align-stretch shopDetail_fd9_0_c1_c2_babdd">
                <template v-for="(child, key1) in item.thumb">
                  <view class="flex flex-direction flex-wrap align-stretch self-center shopDetail_fd9_0_c1_c2_c0_babdd"
                    :key="key1">
              ...
              <view class="flex flex-wrap align-center self-center flex-sub shopDetail_fd9_0_c1_c3_babdd">
                ...
                <view class="flex flex-wrap align-center shopDetail_fd9_0_c1_c3_c1_babdd">
                  ...
                  <image class="shopDetail_fd9_0_c1_c3_c1_c1_babdd" mode="aspectFit" :src="STATIC_URL + '76.png'">
                  </image>
                  <text class="shopDetail_fd9_0_c1_c3_c1_c2_babdd">{{ $t('点赞') }}</text>
                  <image class="shopDetail_fd9_0_c1_c3_c1_c1_babdd" mode="aspectFit" :src="STATIC_URL + '94.png'"
                    v-if="item.is_likes == '0'"></image>
                  <image class="shopDetail_fd9_0_c1_c3_c1_c1_babdd" mode="aspectFit" :src="STATIC_URL + '493.png'"
                    v-if="item.is_likes != '0'"></image>
                </view>
              </view>
            </view>
      ...
      <!---flex布局flex布局结束-->
      <!---flex布局flex布局开始-->
      <view class="flex flex-direction align-stretch benben-flex-layout shopDetail_flex_10_babdd"
        v-if="dataDetails.body">
          ...
          <view class="flex flex-direction flex-wrap align-stretch shopDetail_fd12_0_babdd">
            <view class="flex flex-wrap align-center justify-between shopDetail_fd12_0_c0_babdd">
              ...
              <view class="flex flex-wrap align-center shopDetail_fd12_0_c0_c2_babdd">
                <image class="shopDetail_fd12_0_c0_c2_c0_babdd" mode="aspectFit" :src="STATIC_URL + '93.png'"
      ...
      <benben-popup v-model="popupShow1679637574316" :mask="true" :mask-close-able="true" mode="bottom">
        ...
        <view class="flex flex-direction align-stretch benben-flex-layout shopDetail_flex_13_babdd">
          <view class="flex flex-wrap align-center justify-between shopDetail_fd13_0_babdd">
            ...
            <image class="shopDetail_fd13_0_c2_babdd" mode="aspectFit" :src="STATIC_URL + '93.png'"
              @tap.stop="popupShow1679637574316 = false"></image>
          </view>

          <scroll-view class="shopDetail_fd13_1_babdd" :scroll-x="false" :scroll-y="true" :show-scrollbar="false"
            :enhanced="true">
            <view class="flex flex-direction align-stretch benben-scroll flex">
        ...
        <view class="flex flex-direction flex-wrap align-stretch benben-flex-layout">
          <view class="flex flex-direction flex-wrap align-stretch shopDetail_fd14_0_babdd">
            <view class="flex flex-wrap align-center justify-between shopDetail_fd14_0_c0_babdd">
              ...
              <image class="shopDetail_fd14_0_c0_c2_babdd" mode="aspectFit" :src="STATIC_URL + '85.png'"
                @tap.stop="popupShow1679630010186 = false"></image>
            </view>

            <scroll-view class="shopDetail_fd14_0_c1_babdd" :scroll-x="false" :scroll-y="true" :show-scrollbar="false"
              :enhanced="true">
              <view class="flex flex-direction align-stretch benben-scroll flex">
                <template v-for="(item, key0) in dataDetails.coupon_list">
                  <view class="flex flex-direction align-stretch" :key="key0">
                    <view class="flex flex-direction flex-wrap align-stretch shopDetail_fd14_0_c1_c0_c0_babdd"
                      v-if="item.is_receive != '1'">
                      <view class="flex flex-wrap align-center shopDetail_fd14_0_c1_c0_c0_c0_babdd">
                        <image class="shopDetail_fd14_0_c1_c0_c0_c0_c0_babdd" mode="aspectFit"
                          :src="STATIC_URL + '88.png'"></image>
                        <view
                          class="flex flex-direction flex-wrap align-stretch flex-sub shopDetail_fd14_0_c1_c0_c0_c0_c1_babdd">
                          <view class="flex flex-wrap align-center">
                        ...
                        <view class="flex flex-wrap align-center">
                          ...
                          <text class="shopDetail_fd14_0_c1_c0_c0_c0_c2_c1_babdd">
                            <text
                              class="shopDetail_price1_fd14_0_c1_c0_c0_c0_c2_c1_babdd">{{ item.money | frontPrice }}</text>
                            <text
                              class="shopDetail_price2_fd14_0_c1_c0_c0_c0_c2_c1_babdd">{{ item.money | laterPrice }}</text>
                          </text>
                        </view>
                      </view>
                      <view class="flex flex-wrap align-center justify-between shopDetail_fd14_0_c1_c0_c0_c1_babdd">
                        ...
                        <button class="shopDetail_fd14_0_c1_c0_c0_c1_c1_babdd"
                          @tap.stop="lingqucoupon_idFunc(item.aid)">{{ $t('立即领取') }}</button>
                      </view>
                    </view>
                    <view class="flex flex-direction flex-wrap align-stretch shopDetail_fd14_0_c1_c0_c1_babdd"
                      v-if="item.is_receive == '1'">
                      <view class="flex flex-wrap align-center shopDetail_fd14_0_c1_c0_c0_c0_babdd">
                        <image class="shopDetail_fd14_0_c1_c0_c0_c0_c0_babdd" mode="aspectFit"
                          :src="STATIC_URL + '90.png'"></image>
                        <view
                          class="flex flex-direction flex-wrap align-stretch flex-sub shopDetail_fd14_0_c1_c0_c0_c0_c1_babdd">
                          <view class="flex flex-wrap align-center">
                ...
                <benben-empty :list-data="dataDetails.coupon_list">
                  <view>
                    <view class="flex flex-direction flex-wrap align-center shopDetail_fd14_0_c1_c1_babdd">
                      <image class="shopDetail_fd14_0_c1_c1_c0_babdd" mode="widthFix" :src="STATIC_URL + '423.png'">
                      </image>
                    </view>
                  </view>
                </benben-empty>
      ...
      <benben-popup v-model="popupShow1665473180775" :mask="true" :mask-close-able="true" mode="bottom">
        ...
        <view class="flex flex-direction flex-wrap align-stretch benben-flex-layout shopDetail_flex_15_babdd">
          <view class="flex flex-wrap align-center justify-between shopDetail_fd15_0_babdd">
            ...
            <image class="shopDetail_fd15_0_c2_babdd" mode="aspectFit" :src="STATIC_URL + '93.png'"
              @tap.stop="popupShow1665473180775 = false"></image>
          </view>

          <scroll-view class="shopDetail_fd15_1_babdd" :scroll-x="false" :scroll-y="true" :show-scrollbar="false"
            :enhanced="true">
            <view class="flex flex-direction align-stretch benben-scroll flex">
              <text class="shopDetail_fd15_1_c0_babdd"
                v-if="dataDetails.freight_explain != ''">{{ dataDetails.freight_explain }}</text>
      ...
      <view class="flex flex-direction align-stretch benben-position-layout flex shopDetail_flex_16_babdd"
        v-if="dibu === true">
 ...
 -->
        <view class="flex align-center justify-between flex-sub shopDetail_fd16_2_babdd">
          <view class="flex align-stretch justify-around flex-sub shopDetail_fd16_0_babdd">
            ...
            <view class="flex flex-direction flex-wrap align-center shopDetail_fd16_0_c3_babdd"
              @tap.stop="handleJumpDiy" data-type="switchTab" :data-url="`/pages/tabBar/shopping/shopping`">
              <image class="shopDetail_fd16_0_c0_c0_babdd" mode="aspectFit" :src="STATIC_URL + '83.png'"></image>
              <benben-message-num class="shopDetail_fd16_0_c3_c1_babdd" :message-num="dataNum.count" size="20"
                color="#fff" background-color="red"></benben-message-num>
              <text class="shopDetail_fd16_2_c0_c0_c1_babdd">{{ $t('购物车') }}</text>
            </view>
          </view>
          <button class="shopDetail_fd16_2_c1_babdd" @tap.stop="carSpecificationsFunc()"
            v-if="dataDetails.is_sale == '1' && dataDetails.is_check == '1'">
            {{ $t('加入购物车') }}
          </button>
          <view class="flex flex-direction flex-wrap align-center self-center justify-center shopDetail_fd16_2_c2_babdd"
            v-if="dataDetails.is_sale == '1' && dataDetails.is_check == '1'">
          ...
          <button class="shopDetail_fd16_2_c3_babdd"
            v-if="dataDetails.is_sale == 0 || dataDetails.is_check == 0">{{ $t('商品已下架') }}</button>
        </view>
      </view>
      ...
      <benben-popup v-model="popupShow1686125027669" :mask="true" :mask-close-able="true" mode="bottom">
        ...
        <view class="flex flex-direction flex-wrap align-stretch benben-flex-layout shopDetail_flex_17_babdd">
          <view class="flex flex-direction flex-wrap align-stretch shopDetail_fd17_0_babdd">
            <view class="flex flex-wrap align-center justify-between shopDetail_fd17_0_c0_babdd">
              ...
              <view class="flex flex-wrap align-center shopDetail_fd17_0_c0_c2_babdd">
                <image class="shopDetail_fd17_0_c0_c2_c0_babdd" mode="aspectFit" :src="STATIC_URL + '93.png'"
          ...
          <view class="flex flex-direction flex-wrap align-stretch self-center justify-center shopDetail_fd17_1_babdd">
            <scroll-view class="shopDetail_fd17_1_c0_babdd" :scroll-x="false" :scroll-y="true" :show-scrollbar="false"
              :enhanced="true">
              <view class="flex flex-direction align-stretch benben-scroll flex">
                <benben-select-diy ref="showSelectPopup1693557567723" class-text="flex-direction align-stretch flex"
                  :items.sync="addressList" v-model="address_id" @change="chooseAddrFunc($event)" default-type="aid"
                  :allow-cancel="false" type="radio" :disabled="false" v-if="addressList.length > 0">
                    ...
                    <template #selected>
                      <view class="flex flex-direction align-stretch flex">
                        <view class="flex flex-wrap align-center shopDetail_fd17_1_c0_c0_c0_c0_babdd">
                          <image class="shopDetail_fd17_1_c0_c0_c0_c0_c0_babdd" mode="aspectFit"
                          ...
                          <view class="flex flex-direction flex-wrap align-stretch flex-sub">
                            <view class="flex align-center shopDetail_fd17_1_c0_c0_c0_c0_c1_c0_babdd">
                              <view class="flex flex-wrap align-center shopDetail_fd17_1_c0_c0_c0_c0_c1_c0_c0_babdd">
                                <text
                                  class="shopDetail_fd17_1_c0_c0_c0_c0_c1_c0_c0_c0_babdd">{{ item.label_name }}</text>
                              </view>
                              ...
                              <text class="shopDetail_fd17_1_c0_c0_c0_c0_c1_c0_c3_babdd"
                                v-if="item.sex == '1'">{{ $t('先生') }}</text>
                              <text class="shopDetail_fd17_1_c0_c0_c0_c0_c1_c0_c2_babdd"
                                v-if="item.sex != '1'">{{ $t('女士') }}</text>
                              <text class="shopDetail_fd17_1_c0_c0_c0_c0_c1_c0_c3_babdd">)</text>
                              <text
                                class="flex-sub shopDetail_fd17_1_c0_c0_c0_c0_c1_c0_c5_babdd">{{ item.mobile }}</text>
                            </view>
                          ...
                          <view class="flex flex-wrap align-center shopDetail_fd17_1_c0_c0_c0_c0_c2_babdd">
                            <image class="shopDetail_fd17_1_c0_c0_c0_c0_c2_c0_babdd" mode="aspectFit"
                              :src="STATIC_URL + '127.png'"></image>
                ...
                <benben-empty :list-data="addressList">
                  <view>
                    <view class="flex flex-direction flex-wrap align-center shopDetail_fd17_1_c0_c1_babdd">
                      <image class="shopDetail_fd17_1_c0_c1_c0_babdd" mode="widthFix" :src="STATIC_URL + '423.png'">
                      </image>
                    </view>
                  </view>
                </benben-empty>
          ...
          <view class="flex flex-wrap align-center justify-center shopDetail_fd17_2_babdd" @tap.stop="handleJumpDiy"
            data-type="navigateTo" :data-url="`/pages/wd/editAddress/editAddress`">
  ...
  .page {
    ...
    .shopDetail_fd14_0_babdd {
      ...
      .shopDetail_fd14_0_c1_c0_c1_babdd {
        background: url(#{image-path('89.png')
      }) no-repeat,
      transparent;
      background-size: 100% auto !important;
