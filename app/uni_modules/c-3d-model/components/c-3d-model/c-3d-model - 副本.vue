<template>
	...
	<view class="c-3d-model"  :style="{width,height}"  :modelData="modelData" :change:modelData="three.init" :fun='fun'
		:change:fun='three.callPlayer' :actions='actions' :change:actions='three.playAnimationTwo' :model3dStatus='model3dStatus' :change:model3dStatus='three.setModel3dStatus' >
...
<script>
	...
	export default {
		...
		methods: {
			...
			set3dmodelStatus(sta)
			{
				this.model3dStatus=sta
			},
			playAnimation(i = 0) {
				this.call('play', i)
			},
