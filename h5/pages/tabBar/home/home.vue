<template>
  <page-body :is-tabbar="true" page-path="/pages/tabBar/home/home">
    <view class="page">
      <view class="flex flex-direction align-around benben-position-layout flex home_flex_0_babdd"
        ...
        <view class="flex align-center justify-between home_fd0_0_babdd" style="margin-top: 24rpx">
          ...
          <view class="flex align-center home_fd0_0_c1_babdd" @tap="handleJumpDiy" data-type="navigateTo"
            :data-url="`/pages/wd/myNews/myNews`" v-if="appSystemIdentification != 'Wechat'">
            <image class="home_fd0_0_c1_c0_babdd" mode="aspectFit" :src="STATIC_URL + '14.png'"
              @tap.stop="handleJumpDiy" data-type="navigateTo" :data-url="`/pages/wd/signinPage/signinPage`"></image>
            <image class="home_fd0_0_c1_c1_babdd" mode="aspectFit" :src="STATIC_URL + '15.png'"></image>
            <benben-message-num class="home_fd0_0_c1_c2_babdd" :message-num="messageNum.all" size="20" color="#fff"
              background-color="#FD433C" v-if="messageNum.all != ''"></benben-message-num>
          </view>
        </view>
        <view class="flex flex-wrap align-center home_fd0_1_babdd" v-if="appSystemIdentification != 'Wechat'">
          ...
          <view style="position: relative">
            <swiper ref="benbenSwiperfd0_1_c1" @change="bannerIndexfd0_1_c1 = $event.detail.current"
              class="flex position-relative home_fd0_1_c1_babdd" previous-margin="0rpx" next-margin="0rpx"
              :display-multiple-items="1" :vertical="true" :interval="5000" :duration="500" :autoplay="true"
              :circular="true">
              <template v-for="(item, key0) in faxianList">
                <swiper-item class="flex home_fd0_1_c1_c1_babdd" @tap.stop="handleJumpDiy" data-type="navigateTo"
                  :data-url="`/pages/sy/search/search?name=${item.name}`" :key="key0">
      ...
      <view class="flex flex-direction align-stretch benben-flex-layout">
        <view class="flex flex-direction align-stretch home_fd3_0_babdd">
          <view class="flex flex-direction align-stretch" v-if="tabs == 0 && dataList.diy_cate_list.length > 0">
            <view style="position: relative">
              <swiper ref="benbenSwiperfd3_0_c0_c0" :current="bannerIndexfd3_0_c0_c0"
                    ...
                    <view class="flex flex-wrap align-stretch home_fd3_0_c0_c0_c1_babdd">
                      <template v-for="(child, key1) in item.child">
                        <view
                          ...
                          <image class="home_fd3_0_c0_c0_c1_c0_c0_c0_babdd" mode="aspectFill" :src="child.thumb">
                          </image>
              ...
              <view style="position: absolute"
                class="flex dot flex align-center justify-center home_swiperDotfd3_0_c0_c0_babdd">
                <template v-for="(item, index) in dataList.diy_cate_list.length">
                  <view :key="index" v-if="bannerIndexfd3_0_c0_c0 == index"
          ...
          <view style="position: relative"
            ...
            <swiper ref="benbenSwiperfd3_0_c3" :current="bannerIndexfd4_0_c3"
              @change="bannerIndexfd3_0_c3 = $event.detail.current" class="flex position-relative home_fd3_0_c3_babdd"
            ...
            <view style="position: absolute"
              ...
              <template v-for="(item, index) in secondaryClassifieds.diy_category_list.length">
                <view :key="index" v-if="bannerIndexfd3_0_c3 == index"
      ...
      <view class="flex flex-wrap align-center justify-center benben-flex-layout" v-if="tabs == 0">
        <view style="position: relative">
          <swiper ref="benbenSwiperfd4_0" :current="index" @change="changeSwiperFunc($event)"
            class="flex position-relative home_fd4_0_babdd" previous-margin="0rpx" next-margin="0rpx"
            ...
            <template v-for="(item, key0) in dataRotograph">
              <swiper-item class="flex home_fd4_0_babdd" :key="key0">
                <image class="home_fd4_0_c1_c0_babdd" mode="aspectFill" :src="item.thumb"
      ...
      <view class="flex flex-direction align-stretch benben-flex-layout home_flex_5_babdd" v-if="tabs == 0">
        <view class="flex flex-wrap align-center home_fd5_0_babdd" @tap.stop="handleJumpDiy" data-type="navigateTo"
          ...
          <view style="position: relative">
            <swiper ref="benbenSwiperfd5_0_c2" :current="message_index"
              @change="bannerIndexfd5_0_c2 = $event.detail.current" class="flex position-relative home_fd5_0_c2_babdd"
              previous-margin="0rpx" next-margin="0rpx" :display-multiple-items="1" :vertical="true" :interval="5000"
              ...
              <template v-for="(item, key0) in articleList">
                <swiper-item class="flex home_fd5_0_c2_babdd" :key="key0">
                  <view class="flex flex-wrap align-center home_fd5_0_c2_c1_c0_babdd" @tap.stop="handleJumpDiy"
                    data-type="navigateTo" :data-url="`/pages/sy/articleDetails/articleDetails?id=${item.aid}`">
          ...
          <view class="flex flex-wrap align-center">
            <text class="home_fd5_0_c3_c0_babdd" @tap.stop="handleJumpDiy" data-type="navigateTo"
              :data-url="`/pages/sy/articleList/articleList`">
              {{ $t('更多') }}
            </text>
      ...
      <view class="flex benben-flex-layout flex-wrap align-center home_flex_7_babdd">
        <template v-for="(item, key0) in subadvertisement">
          <view class="flex flex-wrap align-center home_fd7_0_babdd" v-if="tabs == '0'" :key="key0">
            <image class="home_fd7_0_c0_babdd" mode="scaleToFill" :src="item.thumb"
              @tap.stop="conterGoPageFunc(item.href)"></image>
          </view>
        </template>
      </view>
      ...
      <view class="flex flex-direction flex-wrap align-stretch benben-flex-layout home_flex_8_babdd">
        <view class="flex flex-direction align-stretch justify-between home_fd8_0_babdd" v-if="tabs == '0'">
          <benben-select-diy ref="showSelectPopup1687330721289" class-text="align-center justify-between flex"
            :items.sync="tjStatusType" v-model="tjStatus" @change="goodsListFunc()" default-type="value"
        ...
        <view class="flex-sub">
          <benben-waterfalls ref="waterfalls1706931710311" :waterfall-data.sync="waterfallsfd8_1"
            v-model="dataGoodsList" id-key="aid" add-time="200" column-count="2" left-gap="0" right-gap="0"
            column-gap="20rpx">
            <benben-waterfalls-item :sort-index="sortIndex" :key="sortIndex"
              v-for="(waterfall, sortIndex) in waterfallsfd8_1">
              <template v-for="waterfallIndex in waterfall">
                <template v-if="dataGoodsList[waterfallIndex]">
                  <view class="flex flex-direction align-stretch home_fd8_1_c0_babdd" @tap.stop="handleJumpDiy"
                    data-type="navigateTo"
                    :data-url="`/pages/fl/shopDetail/shopDetail?id=${dataGoodsList[waterfallIndex].aid}`"
                    :key="waterfallIndex">
                    <image class="home_fd8_1_c0_c0_babdd" mode="widthFix" :src="dataGoodsList[waterfallIndex].thumb">
                    </image>
                    <view class="home_fd8_1_c0_c1_babdd">
                      <text class="home_fd8_1_c0_c1_c0_babdd"
                        v-if="dataGoodsList[waterfallIndex].is_new == '1'">{{ $t('新品') }}</text>
                    ...
                    <view class="flex flex-wrap align-center home_fd8_1_c0_c2_babdd">
                      <view class="flex flex-wrap align-center"
                        v-if="dataGoodsList[waterfallIndex].active_info.active_id">
                        <text class="home_fd8_1_c0_c2_c0_c0_babdd"
                          v-if="dataGoodsList[waterfallIndex].active_info.type == '1'">
                          {{ $t('秒杀') }}
                        </text>
                        <text class="home_fd8_1_c0_c2_c0_c0_1_babdd"
                          v-if="dataGoodsList[waterfallIndex].active_info.type == '2'">
                          {{ $t('拼团') }}
                        </text>
                        <text class="home_fd8_1_c0_c2_c0_c0_1_babdd"
                          v-if="dataGoodsList[waterfallIndex].active_info.type == '3'">
                          {{ $t('预售') }}
                        </text>
                        <text class="home_fd8_1_c0_c2_c0_c0_1_babdd"
                          v-if="dataGoodsList[waterfallIndex].active_info.type == '4'">
                          {{ $t('特价') }}
                        </text>
                      </view>
                      ...
                      <text class="home_fd8_1_c0_c2_c2_babdd">
                        <text
                          class="home_price1_fd8_1_c0_c2_c2_babdd">{{ dataGoodsList[waterfallIndex].shop_price | frontPrice }}</text>
                        <text
                          class="home_price2_fd8_1_c0_c2_c2_babdd">{{ dataGoodsList[waterfallIndex].shop_price | laterPrice }}</text>
                      </text>
                    ...
                    <!--     <view   class='flex flex-wrap align-center home_fd8_1_c0_c3_babdd'      >
            <view   class='flex flex-wrap align-center home_fd8_1_c0_c3_c0_babdd'      >
        <text class='home_fd8_1_c0_c2_c4_babdd'  >￥</text>
<text class='home_fd8_1_c0_c2_c4_babdd'  >{{dataGoodsList[waterfallIndex].market_price}}</text>
</view>
<text class='home_fd8_1_c0_c2_c3_babdd'  >{{$t('销量')}}</text>
<text class='home_fd8_1_c0_c2_c4_babdd'  >{{dataGoodsList[waterfallIndex].sales_sum}}</text>
</view>
 -->
                    <view class="flex flex-wrap align-center home_fd8_1_c0_c4_babdd">
                      <view class="flex flex-wrap align-center home_fd8_1_c0_c4_c0_babdd"
                        v-if="dataGoodsList[waterfallIndex].discounts != price">
                        <text class="home_fd8_1_c0_c4_c0_c0_babdd">{{ $t('自购返') }}</text>
                      </view>
                      <view class="flex flex-wrap align-center home_fd8_1_c0_c4_c1_babdd"
                        v-if="dataGoodsList[waterfallIndex].share_award_money > 0">
                        <text class="home_fd8_1_c0_c4_c1_c0_babdd">{{ $t('分享赚') }}</text>
                      </view>
                      <view class="flex flex-wrap align-center home_fd8_1_c0_c4_c1_babdd"
                        v-if="dataGoodsList[waterfallIndex].coupon.name">
                        <text
                          class="home_fd8_1_c0_c4_c1_c0_babdd">{{ dataGoodsList[waterfallIndex].coupon.name }}</text>
                      </view>
                    </view>
                    <view class="flex flex-wrap align-center home_fd8_1_c0_c5_babdd" v-if="shopType.status == '1'">
                      <image class="home_fd8_1_c0_c5_c0_babdd" mode="aspectFill"
                        :src="dataGoodsList[waterfallIndex].shop_info.store_logo"></image>
                      <text
                        class="home_fd8_1_c0_c5_c1_babdd">{{ dataGoodsList[waterfallIndex].shop_info.store_name }}</text>
                    </view>
                  </view>
                </template>
              </template>
      ...
      <benben-popup v-model="popupShow1685609745125" :mask="true" :mask-close-able="true" mode="center">
        ...
        <view class="flex flex-direction flex-wrap align-stretch benben-flex-layout home_flex_9_babdd">
          <view class="flex flex-direction flex-wrap align-stretch home_fd9_0_babdd">
            <scroll-view class="home_fd9_0_c0_babdd" :scroll-x="false" :scroll-y="true" :show-scrollbar="true"
              :enhanced="true">
                    ...
                    <view class="flex flex-wrap align-center home_fd9_0_c0_c0_c0_babdd">
                      ...
                      <view class="flex flex-direction flex-wrap align-stretch flex-sub home_fd9_0_c0_c0_c0_c1_babdd">
                        ...
                        <view class="flex flex-wrap align-center">
                          ...
                          <button class="home_fd9_0_c0_c0_c0_c1_c1_c1_babdd"
                            @tap.stop="lqycFunc(item.id)">{{ $t('立即领取') }}</button>
                        </view>
                      </view>
                    </view>
                  </view>
          ...
          <view class="flex flex-wrap align-center justify-center home_fd9_1_babdd">
            <image class="home_fd9_1_c0_babdd" mode="aspectFit" :src="STATIC_URL + '197.png'"
              @tap="popupShow1685609745125 = false"></image>
          </view>
        </view>

        <!---优惠券弹窗flex布局结束-->
      </benben-popup>
      <view class="flex flex-direction align-stretch benben-position-layout flex home_flex_10_babdd"
  ...
  export default {
    ...
    methods: {
      ...
      closeLocatFunc() {
        ...
        //uni.setStorageSync('isGetLocation', 'no')
      },
      //获取是否开启定位
      getisLocationFunc() {
        let isGet = uni.getStorageSync('isGetLocation')
        console.log(isGet, 'isGet')
        if (!isGet || isGet == 'undefined' || isGet == 'no') {
        ...
        uni.$on('indexCity', (e) => {
          this.city = e.city
          uni.setStorageSync('Current_City', this.city)
        })
      },
      //地图API
      amapApiFunc() {
        // this.myAmapFun = new amapFile.AMapWX({
        //   key: '24bd3e9cce29ec3d7ff29ebb3563f17a'
        // });
      },
      //自动定位
      autoGetLocationFunc() {
        ...
        //         _this.city = Array.isArray(regeoData.city) && (regeoData.city
        //           .length == 0) ? regeoData.province : regeoData.city;
        //         uni.setStorageSync('Current_City', _this.city);
        //         _this.getStorListFunc()
        //       },
        //       fail: (info) => {
        //         //失败回调
        //         console.log(info)
      ...
      //开启定位
      getLocatFunc() {
        // uni.setStorageSync('isGetLocation', 'yes')
        // this.isLocation = false
        // this.autoGetLocationFunc();
      },
      //设置语言
...
<style lang="scss" scoped>
  ...
  .home_flex_5_babdd {
    ...
    .home_fd5_0_babdd {
      border-radius: 50rpx;
      background: url(#{image-path('815.png')
    }) no-repeat,
    transparent;
    background-size: 100% auto !important;
    height: 76rpx;
