<template>
  <page-body :is-tabbar="true" page-path="/pages/tabBar/myhb/myhb">
    <view class="page">
      <view class="flex flex-wrap align-center justify-between benben-position-layout flex myhb_flex_0_dija"
        ...
        <view class="flex flex-wrap align-center justify-end myhb_fd0_2_dija"
          :style="{ 'margin-right': `${appSystemIdentification == 'Wechat' ? '30%' : ''}` }" @tap.stop="handleJumpDiy"
          ...
          <benben-message-num class="myhb_fd0_2_c1_dija" :message-num="messageNum.all" size="24" color="#fff"
            background-color="red"></benben-message-num>
        </view>
      </view>
      ...
      <view class="flex flex-direction flex-wrap align-stretch benben-flex-layout myhb_flex_2_dija">
        <view class="flex flex-wrap align-center myhb_fd2_0_dija" @tap.stop="goziliaoFunc()" v-if="isLogin === true">
          ...
          <view class="flex flex-direction flex-wrap align-stretch flex-sub myhb_fd2_0_c1_dija">
            ...
            <view class="flex flex-wrap align-center myhb_fd2_0_c1_c1_dija" v-if="isLogin === true">
              ...
              <view class="flex flex-wrap align-center myhb_fd2_0_c1_c1_c2_dija"
                @tap.stop="copyText(dataMessage.invite_code)">
                <text class="myhb_fd2_0_c1_c1_c2_c0_dija">{{ $t('复制') }}</text>
              </view>
            </view>
          </view>
          <image class="myhb_fd2_0_c2_dija" mode="aspectFit" :src="STATIC_URL + '410.png'" v-if="isLogin === true">
          </image>
        </view>
        <view class="flex flex-wrap align-center myhb_fd2_0_dija" @tap.stop="toLoginDiy()" v-if="isLogin === false">
          <image class="myhb_fd2_1_c0_dija" mode="aspectFit" :src="STATIC_URL + '331.png'" v-if="isLogin === false">
          </image>
        ...
        <view class="flex flex-direction flex-wrap align-stretch myhb_fd2_2_dija" v-if="isLogin === true">
          <view class="flex flex-wrap align-center">
            ...
            <view class="flex flex-wrap align-center myhb_fd2_2_c0_c3_dija" @tap.stop="handleJumpDiy"
              data-type="navigateTo" :data-url="`/pages/wd/member/member`">
          ...
          <view class="flex flex-wrap align-center myhb_fd2_2_c1_dija">
            <view class="flex benben-progress-bar myhb_fd2_2_c1_c0_dija" v-if="dataDetails.levelid != '3'">
              <view class="benben-progress-bar-center myhb_progress1_fd2_2_c1_c0_dija"
                :style="{ width: dataDetails.next_speed + '%' }"></view>
              <image class="benben-progress-bar-image myhb_progress2_fd2_2_c1_c0_dija" mode="aspectFit"
                :src="STATIC_URL + '404.png'" :style="{ left: dataDetails.next_speed + '%' }"></image>
            </view>
 ...
 -->
      ...
      <view class="flex flex-direction align-stretch benben-flex-layout myhb_flex_4_dija">
        <view class="flex flex-wrap align-center justify-around myhb_fd4_0_dija">
          ...
          <view class="flex flex-wrap align-center" @tap.stop="handleJumpDiy" data-type="navigateTo"
            :data-url="`/pages/wd/myTrack/myTrack`">
        ...
        <view class="flex flex-direction flex-wrap align-stretch myhb_fd4_1_dija">
          ...
          <view class="flex align-center justify-between myhb_fd4_1_c1_dija">
            <view class="flex flex-direction flex-wrap align-center myhb_fd4_1_c1_c0_dija" @tap.stop="handleJumpDiy"
              data-type="navigateTo" :data-url="`/pages/ddgl/order/order?type=unpay`">
              <benben-message-num class="myhb_fd4_1_c1_c0_c0_dija" :message-num="dataNum.no_pay" size="24" color="#fff"
                background-color="red"></benben-message-num>
            ...
            <view class="flex flex-direction flex-wrap align-center myhb_fd4_1_c1_c0_dija" @tap.stop="handleJumpDiy"
              data-type="navigateTo" :data-url="`/pages/ddgl/order/order?type=unship`">
              ...
              <benben-message-num class="myhb_fd4_1_c1_c1_c2_dija" :message-num="dataNum.deliver" size="24" color="#fff"
                background-color="red"></benben-message-num>
            </view>
            <view class="flex flex-direction flex-wrap align-center myhb_fd4_1_c1_c0_dija" @tap.stop="handleJumpDiy"
              data-type="navigateTo" :data-url="`/pages/ddgl/order/order?type=unreceive`">
              ...
              <benben-message-num class="myhb_fd4_1_c1_c1_c2_dija" :message-num="dataNum.receiv" size="24" color="#fff"
                background-color="red"></benben-message-num>
            </view>
            <view class="flex flex-direction flex-wrap align-center myhb_fd4_1_c1_c0_dija" @tap.stop="handleJumpDiy"
              data-type="navigateTo" :data-url="`/pages/ddgl/order/order?type=finish`">
              ...
              <benben-message-num class="myhb_fd4_1_c1_c1_c2_dija" :message-num="dataNum.evaluate" size="24"
                color="#fff" background-color="red"></benben-message-num>
            </view>
            <view class="flex flex-direction flex-wrap align-center myhb_fd4_1_c1_c0_dija" @tap.stop="handleJumpDiy"
              data-type="navigateTo" :data-url="`/pages/ddgl/order/order?type=6`">
              ...
              <benben-message-num class="myhb_fd4_1_c1_c4_c2_dija" :message-num="dataNum.refund" size="24" color="#fff"
                background-color="red"></benben-message-num>
            </view>
          </view>
        </view>
        ...
        <view class="flex flex-wrap align-stretch myhb_fd4_3_dija">
          <view class="flex flex-direction align-center myhb_fd4_3_c0_dija" @tap.stop="handleJumpDiy"
          ...
          <view class="flex flex-direction align-center myhb_fd4_3_c0_dija" @tap.stop="handleJumpDiy"
            data-type="navigateTo" :data-url="`/pages/wd/promotionTeam/promotionTeam`">
          ...
          <view class="flex flex-direction align-center myhb_fd4_3_c0_dija" @tap.stop="handleJumpDiy"
            data-type="navigateTo" :data-url="`/pages/wd/couponMy/couponMy`">
          ...
          <view class="flex flex-direction align-center myhb_fd4_3_c0_dija" @tap.stop="handleJumpDiy"
            data-type="navigateTo" :data-url="`/pages/fp/invoicesManagement/invoicesManagement`">
      ...
      <view class="flex flex-direction flex-wrap align-stretch benben-flex-layout myhb_flex_5_dija">
        ...
        <view class="flex-sub">
          <benben-waterfalls ref="waterfalls1730518154727" :waterfall-data.sync="waterfallsfd5_1"
            ...
            <benben-waterfalls-item :sort-index="sortIndex" :key="sortIndex"
              v-for="(waterfall, sortIndex) in waterfallsfd5_1">
              <template v-for="waterfallIndex in waterfall">
                <template v-if="dataGoodsList[waterfallIndex]">
                  <view class="flex flex-direction align-center myhb_fd5_1_c0_dija" @tap.stop="handleJumpDiy"
                    data-type="navigateTo"
                    :data-url="`/pages/fl/shopDetail/shopDetail?id=${dataGoodsList[waterfallIndex].aid}`"
                    :key="waterfallIndex">
                    <image class="myhb_fd5_1_c0_c0_dija" mode="widthFix" :src="dataGoodsList[waterfallIndex].thumb">
                    </image>
                    ...
                    <view class="flex flex-wrap align-center myhb_fd5_1_c0_c2_dija">
                      ...
                      <text class="myhb_fd5_1_c0_c2_c1_dija">
                        ...
                        <text
                          class="myhb_price2_fd5_1_c0_c2_c1_dija">{{ dataGoodsList[waterfallIndex].shop_price | laterPrice }}</text>
                      </text>
