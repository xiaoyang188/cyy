<template>
    <page-body   >
        <view class="page" >
    <view class="flex benben-position-layout flex flex-wrap align-center articleList_flex_0_babdd"    :style="{height:(88+StatusBarRpx)+'rpx',paddingTop:StatusBarRpx+'rpx', }">
            <view   class='flex flex-wrap align-center justify-between flex-sub articleList_fd0_0_babdd'      >
            <view   class='flex flex-wrap align-center justify-center articleList_fd0_0_c0_babdd'   @tap.stop="handleJumpDiy" data-type="back" data-url="1"   >
...
<!---flex布局flex布局开始-->
 <view class="flex flex-direction align-stretch benben-flex-layout"    >
        <view>
        <benben-flex-tabs class-text='articleList_benbenTabsfd1_0_babdd'  v-model="tabs" ref="benben_tabsfd1_0" select-mark="benben_tabsfd1_0" key="benben_tabsfd1_0" :open-title-type='false' :open-sticky='true' :top='0' :is-show-content='false' :scrollspy='false'  :tabs-info.sync="tabsInfofd1_0" @change="getListFunc()" >
            
                    <scroll-view :throttle='false'
        ...
        >
          <view class="benben-tabs-content" id="benben_tabsfd1_0-content">
            ...
            <template v-for = '(item,key0) in dataType'>            <view  :key='key0'
                :class="{ 'checkTitlefd1_0_babdd': tabs == item.category_id, 'flex flex-wrap align-center articleList_titlefd1_0_c3_babdd': true }"
                @tap="tabs = item.category_id"
                :id="`benben_tabsfd1_0-title-item-${item.category_id}`"
...
<text class='articleList_titleItemfd1_0_c3_c0_babdd'  >{{item.category_name}}</text>
            ...
            <view :style="{ left: tabsInfofd1_0.lineleft, maxWidth: tabsInfofd1_0.lineWidth ,}" id="benben_tabsfd1_0-line" class="benben-tabs-line flex benben-flex-tabs-line articleList_linefd1_0_babdd" :class="{'benben-tabs-line-active':tabsInfofd1_0.isInit}"></view>
          </view>
        </scroll-view>
    ...
    <view   class='flex align-center articleList_fd1_1_c0_babdd'   @tap.stop="handleJumpDiy" data-type="navigateTo" :data-url="`/pages/sy/articleDetails/articleDetails?id=${item.aid}`" v-if= " item.thumb!=''"   :key='key0'>
...
import {validate} from '@/common/utils/validate.js'
    ...
    export default {
        ...
        data(){
			return {"tabsInfofd1_0":{ lineleft: '', lineWidth: '', moveX: 0, scrollX: 0, PageScrollX: 0, isInit: false },"minixPagingListsApi":"","pageingListApiMethod":"","allowOnloadGetList":false,"tabs":"","dataType":[],"dataList":[]};
		},
		computed:{
 ...
 this.tabs = this.dataType[0].category_id
                ...
                this.pagingListPostDataContent = {category_id:this.tabs}
                this.listData = [];
...
<style lang="scss" scoped>
    ...
    .articleList_linefd1_0_babdd{
        width:48rpx;height:8rpx;top:80rpx;background:var(--benbenbgColor2);background-size:100% auto !important;border-radius:16rpx;
    }
    ...
    .articleList_fd1_1_c0_babdd{
        border-radius:16rpx 16rpx 16rpx 16rpx;background:#fff;padding:24rpx 24rpx 24rpx 24rpx;margin:0rpx 0rpx 20rpx 0rpx;
        .articleList_fd1_1_c0_c0_babdd{
        width:240rpx;height:180rpx;border-radius:16rpx 16rpx 16rpx 16rpx;
    }    .articleList_fd1_1_c0_c1_babdd{
        margin:0rpx 0rpx 0rpx 24rpx;
        .articleList_fd1_1_c0_c1_c0_babdd{
        line-height:40rpx;font-size:28rpx;font-weight:500;color:var(--benbenFontColor0);-webkit-line-clamp:2;overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-box-orient:vertical;margin:0rpx 0rpx 76rpx 0rpx;height:80rpx;
    }    .articleList_fd1_1_c0_c1_c1_c0_babdd{
        margin:0rpx 0rpx 0rpx 8rpx;line-height:28rpx;font-size:26rpx;font-weight:400;color:var(--benbenFontColor1);
    }}}
    .articleList_flex_0_babdd{
        ...
        font-size:36rpx;font-weight:600;color:var(--benbenFontColor0);line-height:88rpx;
    }}}
    .articleList_fd0_0_c0_babdd{
        width:50rpx;height:50rpx;
        .articleList_fd0_0_c0_c0_babdd{
        font-size:36rpx;color:var(--benbeniconColor1);
    }}}
    ::v-deep .articleList_benbenTabsfd1_0_babdd{
        width:750rpx;height:90rpx;white-space:nowrap;background:#fff;text-align:center;font-size:32rpx;
    }
</style>