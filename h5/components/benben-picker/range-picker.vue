  ...
  methods: {
    ...
    resetData(fyear, fmonth, fday, tyear, tmonth) {
      let fyears = [],
        ...
        tmonths = [],
        tdays = []
      let startYear = this.startYear == '现在' ? this.presentTime : this.startYear
      let endYear = this.endYear == '现在' ? this.presentTime : this.endYear
    ...
    getData(dVal) {
      let startYear1 = this.startYear == '现在' ? this.presentTime : this.startYear
      let endYear1 = this.endYear == '现在' ? this.presentTime : this.endYear
      let start = startYear1 * 1
      let end = endYear1 * 1
      let value = dVal
