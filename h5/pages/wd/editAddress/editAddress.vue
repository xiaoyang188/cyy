<template>
    <page-body   >
        <view class="page" >
    <view class="flex align-stretch benben-position-layout flex editAddress_flex_0_babdd"    :style="{height:(88+StatusBarRpx)+'rpx',paddingTop:StatusBarRpx+'rpx', }">
    ...
    <view   class='flex align-center'      >
        <text class='editAddress_fd0_0_c1_c0_babdd'    v-if= "id==''"  >{{$t('添加地址')}}</text><text class='editAddress_fd0_0_c1_c0_1_babdd'    v-if= "id!=''"  >{{$t('编辑地址')}}</text>
</view>
...
<!---添加地址flex布局开始-->
 <view class="flex flex-direction align-stretch benben-flex-layout"    >
        ...
        <benben-address-label class='editAddress_fd1_0_c0_c1_babdd'  v-model="dataMessage.label_name"      >
...
<benben-input class='flex-sub editAddress_fd1_0_c1_c1_babdd'   type="text" :placeholder="$t('收货人')" confirm-type="done" :maxlength="15" placeholder-style="color:var(--benbenFontColor2);font-size:32rpx"  v-model="dataMessage.real_name" />
    <view   class='flex flex-wrap align-center'      >
            <benben-select-diy ref="showSelectPopup1750835209373" class-text='flex'   :items.sync="sex_type" v-model="dataMessage.sex" :label.sync="sex_id"  default-type="value" default-label="name" :allow-cancel='false' type="radio" :disabled='false'  >
    <benben-select-item v-for = '(item,key0) in sex_type' :hand-value='item.value' :key='key0'>
        <template #selected>    <view   class='flex align-center flex editAddress_fd1_0_c1_c2_c0_c0_babdd'      >
...
</template><template #no-selected>    <view   class='flex align-center flex editAddress_fd1_0_c1_c2_c0_c0_babdd'      >
...
<benben-input class='flex-sub editAddress_fd1_0_c2_c1_babdd'   type="number" :placeholder="$t('联系电话')" confirm-type="done" :maxlength="11" placeholder-style="color:var(--benbenFontColor2);font-size:32rpx"  v-model="dataMessage.mobile" />
</view>
...
<benben-input class='flex-sub editAddress_fd1_0_c3_c0_c1_babdd'   type="text" :placeholder="$t('请选择省市区县、乡镇')" confirm-type="done" :maxlength="-1" :disabled='true' placeholder-style="color:var(--benbenFontColor2);font-size:32rpx"   v-model="dataMessage.address_code_area_str"  />
...
<benben-textarea class='flex editAddress_input_fd1_0_c3_c1_babdd'  confirm-type="done" :placeholder="$t('请填写详细地址：如道路、门牌号、小区、楼栋号等')" :maxlength="240" placeholder-style="color:var(--benbenFontColor2);font-size:28rpx"   v-model="dataMessage.detail" />
    ...
    <view   class='flex flex-wrap align-center justify-between editAddress_fd1_1_babdd'      >
        ...
        <benben-switch class='editAddress_fd1_1_c1_babdd'  v-model="is_default" default-color='var(--benbenFontColor2)' color='var(--benbenFontColor4)' :disabled='false' :auto='true' size='72'      >
        </benben-switch>
</view>
    <view   class='flex flex-wrap align-center justify-center editAddress_fd1_2_babdd'      >
        <button class='editAddress_fd1_2_c0_babdd'  @tap.stop="addAddressFunc()" v-if= " id==''" >{{$t('保存')}}</button><button class='editAddress_fd1_2_c0_1_babdd'  @tap.stop="editAddressFunc()" v-if= " id!=''" >{{$t('保存')}}</button>
</view>
</view>
...
<!--选择器开始 -->
        <benben-picker class="" ref="benbenWritePickerCodepicker3" :visible.sync="pickerDiy1750835034667" :label.sync='dataMessage.address_code_area_str' :province.sync='dataMessage.address_code_province' :city.sync='dataMessage.address_code_city' :area.sync='dataMessage.address_code_district'  mode='region' :mask-show='true' :picker-height='88' :hide-area='false'  >
...
<script>
    ...
    export default {
        ...
        data(){
			return {"pickerDiy1750835034667":false,"popupShow1686733151756":false,"is_default":false,"address":"","sex_type":[{"name":"先生","value":"1","image":""},{"name":"女士","value":"2","image":""}],"sex_id":"1","address_type":[{"name":"公司","value":"1","image":""},{"name":"家","value":"2","image":""}],"address_id":"1",/** address_code_area_str【省市区中文】
...
*   label_name【标签】
*   mobile【电话】
*   aid【ID】 **/ "dataMessage":{"aid":"","mobile":"","label_name":"","sex":"","province_id":"","is_default":"","province":"","city":"","city_id":"","district":"","district_id":"","create_time":"","real_name":"","address_code":"","detail":"","address_code_province":"","address_code_city":"","address_code_district":"","lng":"","lat":"","address_code_area":"","address_code_area_str":""},"real_name":"","dataEssay":[],"dataType":[],"dataDetails":[],/** longitude【经度(lon)】
*   latitude【纬度(lat)】
*   address【详细地址】
*   name【位置名称】 **/ "mapMessage":{"name":"","address":"","latitude":"","longitude":""},/** district【区】
*   city【市】
*   province【省】
*   area【城市】
*   lat【纬度】
*   lng【经度】 **/ "datamap":{"lng":"","lat":"","area":"","province":"","city":"","district":""},"id":""};
		},
		computed:{
...
this.getaddressMessageFunc()
  ...
  let datadataEssay = await this.$api.dbPost(global.apiUrls.post637defdbd53ef, {
    real_name:this.dataMessage.real_name,mobile:this.dataMessage.mobile,detail:this.dataMessage.detail,sex:this.dataMessage.sex,label_name:this.dataMessage.label_name,is_default:this.dataMessage.is_default,lng:this.datamap.lng,lat:this.datamap.lat,province:this.dataMessage.address_code_province,city:this.dataMessage.address_code_city,district:this.dataMessage.address_code_district
  });
  ...
  let datadataDetails = await this.$api.dbPost(global.apiUrls.post637df1ea39d16, {
    address_id:this.id,real_name:this.dataMessage.real_name,mobile:this.dataMessage.mobile,detail:this.dataMessage.detail,sex:this.dataMessage.sex,label_name:this.dataMessage.label_name,is_default:this.dataMessage.is_default,lng:this.dataMessage.lng,lat:this.dataMessage.lat,province:this.dataMessage.address_code_province,city:this.dataMessage.address_code_city,district:this.dataMessage.address_code_district
  });
  ...
  let datadatamap = await this.$api.dbGet(global.apiUrls.post649e954010762, {
    lng:this.mapMessage.longitude,lat:this.mapMessage.latitude
  });
...
<style lang="scss" scoped>
        ...
        padding:0rpx 32rpx 0rpx 32rpx;line-height:100rpx;border-radius:25rpx 25rpx 0rpx 0rpx;border-bottom:1px solid #eee;background:#fff;background-size:100% auto !important;font-size:32rpx;
    ...
    .editAddress_flex_2_babdd{
        background:var(--benbenbgColor1);width:540rpx;border-radius:16rpx 16rpx 16rpx 16rpx;
        .editAddress_fd2_0_babdd{
        line-height:44rpx;font-size:32rpx;font-weight:500;color:var(--benbenFontColor0);margin:48rpx 0rpx 0rpx 0rpx;
    }    .editAddress_fd2_1_babdd{
        line-height:44rpx;font-size:32rpx;font-weight:500;color:var(--benbenFontColor0);margin:40rpx 0rpx 48rpx 0rpx;
    }    .editAddress_fd2_2_c0_babdd{
        line-height:94rpx;border-radius:0rpx 0rpx 0rpx 16rpx;font-size:32rpx;background:var(--benbenbtnColor1);color:var(--benbenFontColor2);padding:0rpx 102rpx 0rpx 103rpx;border-top:1px solid var(--benbenbdColor0);font-weight:400;
    }    .editAddress_fd2_2_c1_babdd{
        line-height:94rpx;border-radius:0rpx 0rpx 16rpx 0rpx;font-size:32rpx;background:var(--benbenbtnColor1);color:var(--benbenFontColor4);border-top:1px solid var(--benbenbdColor0);border-left:1px solid var(--benbenbdColor0);padding:0rpx 102rpx 0rpx 101rpx;font-weight:500;
    }}
    .editAddress_fd1_0_babdd{
        padding:0rpx 24rpx 32rpx 24rpx;background:var(--benbenbgColor1);background-size:100% auto !important;margin:24rpx 24rpx 20rpx 24rpx;border-radius:16rpx;
        .editAddress_fd1_0_c3_c0_babdd{
        padding:32rpx 32rpx 32rpx 0rpx;border-bottom:1px solid var(--benbenbdColor0);margin:0rpx 0rpx 32rpx 0rpx;
        .editAddress_fd1_0_c3_c0_c0_babdd{
        line-height:45rpx;font-size:32rpx;font-weight:400;color:var(--benbenFontColor0);margin:0rpx 16rpx 0rpx 0rpx;
    }    .editAddress_fd1_0_c3_c0_c1_babdd{
        height:45rpx;line-height:45rpx;margin:0rpx 20rpx 0rpx 0rpx;color:var(--benbenFontColor0);
    }    .editAddress_fd1_0_c3_c0_c2_babdd{
        color:var(--benbeniconColor3);font-size:34rpx;
    }}    .editAddress_fd1_0_c3_c1_babdd{
        border-radius:10rpx 10rpx 10rpx 10rpx;background:var(--benbenbgColor2);padding:24rpx 42rpx 48rpx 24rpx;width:680rpx;
        .editAddress_input_fd1_0_c3_c1_babdd{
        width:100%;height:88rpx;font-size:28rpx;font-weight:400;color:var(--benbenFontColor0);
    }}}
    .editAddress_fd1_0_c0_babdd{
        padding:32rpx 32rpx 32rpx 0rpx;border-bottom:1px solid var(--benbenbdColor0);
        .editAddress_fd1_0_c0_c1_babdd{
        --label-avtive-bg:var(--benbenbgColor3);--label-avtive-color:var(--benbenFontColor3);
    }}
    .editAddress_fd1_0_c0_c0_babdd{
        line-height:45rpx;font-size:32rpx;font-weight:400;color:var(--benbenFontColor0);width:168rpx;
    }
    .editAddress_fd1_0_c1_c1_babdd{
        line-height:32rpx;font-size:32rpx;font-weight:400;color:var(--benbenFontColor0);width:200rpx;
    }
    .editAddress_fd1_0_c1_c2_c0_c0_babdd{
        margin:0rpx 0rpx 0rpx 40rpx;
        .editAddress_fd1_0_c1_c2_c0_c0_c0_babdd{
        font-size:36rpx;margin:0rpx 12rpx 0rpx 0rpx;color:var(--benbeniconColor0);
    ...
    .editAddress_fd1_0_c1_c2_c0_c1_c0_babdd{
        font-size:36rpx;margin:0rpx 12rpx 0rpx 0rpx;color:var(--benbeniconColor3);
    }
    .editAddress_fd1_0_c1_c2_c0_c1_c1_babdd{
        line-height:45rpx;font-size:32rpx;font-weight:500;color:var(--benbenFontColor2);
    }
    .editAddress_fd1_0_c2_c1_babdd{
        font-size:32rpx;font-weight:400;color:var(--benbenFontColor0);
    }
    .editAddress_fd1_1_babdd{
        padding:32rpx 32rpx 32rpx 0rpx;margin:0rpx 24rpx 120rpx 24rpx;background:var(--benbenbgColor1);background-size:100% auto;border-radius:16rpx;
        .editAddress_fd1_1_c0_babdd{
        line-height:45rpx;font-size:32rpx;font-weight:400;color:var(--benbenFontColor0);margin:0rpx 0rpx 0rpx 32rpx;
    }}
    .editAddress_fd1_2_babdd{
        ...
        border-radius:44rpx 44rpx 44rpx 44rpx;font-size:32rpx;background:var(--benbenbtnColor0);color:var(--benbenFontColor3);width:702rpx;height:88rpx;line-height:88rpx;font-weight:500;
    }    .editAddress_fd1_2_c0_1_babdd{
        border-radius:44rpx 44rpx 44rpx 44rpx;font-size:32rpx;background:var(--benbenbtnColor0);color:var(--benbenFontColor3);width:686rpx;height:88rpx;line-height:88rpx;font-weight:500;
    }}
