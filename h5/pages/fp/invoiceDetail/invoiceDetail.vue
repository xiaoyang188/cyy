<template>
    <page-body   >
        <view class="page" >
    <view class="flex align-stretch benben-position-layout flex invoiceDetail_flex_0_babdd"    :style="{height:(88+StatusBarRpx)+'rpx',paddingTop:StatusBarRpx+'rpx', }">
    ...
    <view   class='flex align-center invoiceDetail_fd0_0_c0_babdd'      >
        </view>
</view>
...
<view :style="{height: (88+StatusBarRpx)+'rpx'}"  ></view>
 ...
 <view class="flex flex-direction align-stretch benben-flex-layout"    >
        ...
        <text class='invoiceDetail_fd1_0_c0_babdd'    v-if= "dataMessage.invoice_status=='1'"  >{{$t('开票中')}}</text><text class='invoiceDetail_fd1_0_c0_1_babdd'    v-if= "dataMessage.invoice_status=='2'"  >{{$t('已开票')}}</text><text class='invoiceDetail_fd1_0_c0_1_babdd'    v-if= "dataMessage.invoice_status=='3'"  >{{$t('发票作废')}}</text>
...
<text class='flex-wrap align-center invoiceDetail_fd1_0_c1_c1_babdd'   >
    <text >{{ dataMessage.invoice_price | frontPrice }}</text><text >{{ dataMessage.invoice_price | laterPrice }}</text>
</text>
<image class='invoiceDetail_fd1_0_c1_c2_babdd'  mode="aspectFit"  :src='STATIC_URL+"104.png"' @tap.stop="popupShow1661508889761=true" ></image>
</view>
</view>
...
<text class='invoiceDetail_fd1_1_c1_c0_c1_c1_babdd'  >{{dataMessage.order_status}}</text>
    ...
    <view   class='flex flex-wrap align-center invoiceDetail_fd1_1_c1_c1_babdd'      >
        </view>
    <view   class='flex flex-direction flex-wrap align-center invoiceDetail_fd1_1_c1_c2_babdd'      >
        <image class='invoiceDetail_fd1_1_c1_c0_c0_babdd'  mode="aspectFit"  :src='STATIC_URL+"186.png"'  v-if= "dataMessage.invoice_status=='1'"></image><image class='invoiceDetail_fd1_1_c1_c0_c0_babdd'  mode="aspectFit"  :src='STATIC_URL+"448.png"'  v-if= "dataMessage.invoice_status=='2'"></image>
<text class='invoiceDetail_fd1_1_c1_c2_c1_babdd'  >{{$t('开票完成')}}</text>
</view>
</view>
</view>
    <view   class='flex flex-wrap align-center invoiceDetail_fd1_2_babdd'      >
        </view>
...
<text class='flex-sub invoiceDetail_fd1_3_c1_c1_babdd'    v-if= "dataMessage.invoice_type=='1'"  >{{$t('个人')}}</text><text class='flex-sub invoiceDetail_fd1_3_c2_c1_1_babdd'    v-if= "dataMessage.invoice_type!='1'"  >{{$t('企业')}}</text>
</view>
    <view   class='flex flex-wrap align-center invoiceDetail_fd1_3_c0_babdd'      >
...
<text class='invoiceDetail_fd1_3_c8_c1_babdd'     @tap.stop="SavePictureFunc()" >{{$t('下载发票')}}</text>
    ...
    <view   class='flex flex-wrap align-center invoiceDetail_fd1_3_c8_babdd'    v-if= "dataMessage.invoice_status=='2'"  >
        <image class='invoiceDetail_fd1_3_c9_c0_babdd'  mode="aspectFill"  :src='dataMessage.invoice_img'></image>
</view>
</view>
</view>
...
<!---flex布局flex布局开始-->
 <view class="flex flex-direction flex-wrap align-stretch benben-flex-layout invoiceDetail_flex_2_babdd"    >
            <view   class='flex flex-wrap align-center invoiceDetail_fd2_0_babdd'    v-if= "dataMessage.invoice_status=='2'"  >
        </view>
</view>
...
<benben-popup v-model="popupShow1661508889761" :mask="true" :mask-close-able="true"  mode='bottom'  >
 ...
 <view class="flex flex-direction flex-wrap align-stretch benben-flex-layout invoiceDetail_flex_3_babdd"    >
            ...
            <view   class='flex flex-wrap align-center invoiceDetail_fd3_0_c0_babdd'      >
        </view>
...
<image class='invoiceDetail_fd3_0_c4_babdd'  mode="aspectFit"  :src='STATIC_URL+"322.png"' @tap.stop="popupShow1661508889761=false" ></image>
</view>
    ...
    <scroll-view  class='invoiceDetail_fd3_1_babdd'  :scroll-x='false' :scroll-y='true' :show-scrollbar='false'      :enhanced="true">
        <view class='flex flex-direction align-stretch benben-scroll flex' >
                    <jyf-parser class='invoiceDetail_fd3_1_c0_babdd'  :html="dataEssay.content | richTextFormat"  >
        </jyf-parser>
</view>
    </scroll-view>
...
<script>
    ...
    export default {
        ...
        data(){
			return {"popupShow1661508889761":false,"cut":"1",/** invoice_img【发票图片】
*   invoice_email【邮箱】
*   invoice_mobile【手机号】
*   invoice_price【发票金额】
...
*   invoice_type【发票类型】
*   update_time【开票时间】
*   create_time【提交时间】 **/ "dataMessage":{"create_time":"","update_time":"","user_id":"","order_id":"","invoice_type":"","invoice_title":"","invoice_company_duty_paragraph":"","invoice_status":"","invoice_price":"","invoice_mobile":"","invoice_email":"","invoice_img":"","invoice_name":"","order_status":""},/** introduce【简介】
*   content【内容】
*   thumb_img【内容图片】
*   name【页面标题】 **/ "dataEssay":{"aid":"","name":"","thumb_img":"","content":"","introduce":""},/** tempFilePath【文件临时路径路径】 **/ "dataImage":{"tempFilePath":""},"order_id":"1026"};
		},
		computed:{
                  /**
     * @returns 
...
this.getMessageFunc()
  ...
  this.dataEssay = infodataEssay.data
                ...
                this.dataImage = await this.syncUniApi('downloadFile',{'url': this.dataMessage.invoice_img})
                await this.syncUniApi('saveImageToPhotosAlbum',{'filePath': this.dataImage.tempFilePath})
                    uni.showToast({
                        title:this.$t('下载完成'),
                        mask:true,
                        icon:'none',
...
<style lang="scss" scoped>
           .page{
            ...
            background:url(#{image-path('177.png')}) no-repeat;background-size: 100% auto;
            .invoiceDetail_flex_3_babdd{
        background:#fff;background-size:100% auto !important;border-radius:24rpx 24rpx 0rpx 0rpx;padding:0rpx 32rpx 64rpx 32rpx;
        .invoiceDetail_fd3_0_babdd{
        line-height:129rpx;
        .invoiceDetail_fd3_0_c0_babdd{
        width:26rpx;
    }    .invoiceDetail_fd3_0_c1_babdd{
        width:32rpx;height:10rpx;border-radius:0rpx 0rpx 0rpx 0rpx;margin:0rpx 0rpx 0rpx auto;
    }    .invoiceDetail_fd3_0_c2_babdd{
        margin:0rpx 20rpx 0rpx 20rpx;font-size:32rpx;font-weight:500;color:var(--benbenFontColor0);
    }    .invoiceDetail_fd3_0_c3_babdd{
        width:32rpx;height:10rpx;border-radius:0rpx 0rpx 0rpx 0rpx;margin:0rpx auto 0rpx 0rpx;
    }    .invoiceDetail_fd3_0_c4_babdd{
        width:40rpx;height:40rpx;
    }}    .invoiceDetail_fd3_1_babdd{
        touch-action:none;height:40vh;width:686rpx;
    }}
    .invoiceDetail_flex_2_babdd{
        background:#fff;background-size:100% auto !important;padding:16rpx 24rpx 16rpx 24rpx;
    ...
    .invoiceDetail_fd1_0_babdd{
        ...
        line-height:43rpx;font-size:32rpx;font-weight:700;color:var(--benbenFontColor3);margin:0rpx 0rpx 32rpx 0rpx;
    }    .invoiceDetail_fd1_0_c1_c0_babdd{
        line-height:42rpx;font-size:28rpx;font-weight:400;color:var(--benbenFontColor3);
    }    .invoiceDetail_fd1_0_c1_c1_babdd{
        line-height:40rpx;font-size:28rpx;font-weight:400;color:var(--benbenFontColor3);
    }    .invoiceDetail_fd1_0_c1_c2_babdd{
        width:32rpx;height:32rpx;border-radius:0rpx 0rpx 0rpx 0rpx;margin:0rpx 0rpx 0rpx 24rpx;
    }}
    .invoiceDetail_fd1_0_c0_1_babdd{
        line-height:43rpx;font-size:32rpx;font-weight:700;color:#FFFFFF;margin:0rpx 0rpx 32rpx 0rpx;
    }
    .invoiceDetail_fd1_1_babdd{
        border-radius:16rpx 16rpx 0rpx 0rpx;background:var(--benbenbgColor1);background-size:100% auto !important;padding:40rpx 0rpx 32rpx 0rpx;
        ...
        line-height:42rpx;font-size:28rpx;font-weight:400;color:var(--benbenFontColor0);
    }    .invoiceDetail_fd1_1_c1_c0_c1_c1_babdd{
        line-height:42rpx;font-size:28rpx;font-weight:400;color:#666666;
    }}}    .invoiceDetail_fd1_1_c1_c1_babdd{
        height:1rpx;background:rgba(238, 238, 238, 1);background-size:100% auto !important;width:232rpx;margin:31rpx 0rpx 0rpx 0rpx;
    }    .invoiceDetail_fd1_1_c1_c2_babdd{
        margin:0rpx 0rpx 0rpx -32rpx;
        .invoiceDetail_fd1_1_c1_c2_c1_babdd{
        line-height:42rpx;font-size:28rpx;font-weight:400;color:var(--benbenFontColor1);margin:16rpx 0rpx 0rpx 0rpx;
    }}}}
    ...
    .invoiceDetail_fd1_1_c1_c0_c0_babdd{
        width:48rpx;height:48rpx;border-radius:0rpx 0rpx 0rpx 0rpx;
    }
    .invoiceDetail_fd1_2_babdd{
        background:var(--benbenbgColor5);background-size:100% auto !important;height:20rpx;
    }
    .invoiceDetail_fd1_3_babdd{
        background:var(--benbenbgColor1);background-size:100% auto !important;padding:16rpx 24rpx 016rpx 024rpx;
    }
    .invoiceDetail_fd1_3_c0_babdd{
        padding:16rpx 0rpx 16rpx 0rpx;
    }
    .invoiceDetail_fd1_3_c0_c0_babdd{
        line-height:40rpx;font-size:28rpx;font-weight:400;color:var(--benbenFontColor1);width:136rpx;
    }
    .invoiceDetail_fd1_3_c1_c1_babdd{
        line-height:40rpx;font-size:28rpx;font-weight:400;color:var(--benbenFontColor0);-webkit-line-clamp:1;overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-box-orient:vertical;
    }
    .invoiceDetail_fd1_3_c2_c1_1_babdd{
        line-height:40rpx;font-size:28rpx;font-weight:400;color:#333333;-webkit-line-clamp:1;overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-box-orient:vertical;
    }
    .invoiceDetail_fd1_3_c5_c2_babdd{
        color:var(--benbenFontColor0);font-weight:400;line-height:42rpx;font-size:28rpx;
    }
    .invoiceDetail_fd1_3_c8_babdd{
        margin:24rpx 0rpx 0rpx 0rpx;
        .invoiceDetail_fd1_3_c8_c0_babdd{
        font-size:28rpx;font-weight:400;color:var(--benbenFontColor4);margin:0rpx 24rpx 0rpx 0rpx;
    }    .invoiceDetail_fd1_3_c8_c1_babdd{
        color:var(--benbenFontColor4);font-size:28rpx;font-weight:400;line-height:28rpx;
    }}
    .invoiceDetail_fd1_3_c9_c0_babdd{
        width:702rpx;height:454rpx;border-radius:0rpx 0rpx 0rpx 0rpx;
    }
    .invoiceDetail_flex_0_babdd{
        width:750rpx;height:88rpx;overflow:hidden;z-index:10;top:0rpx;background:url(#{image-path('177.png')}) no-repeat;background-size:100% auto !important;
    ...
    .invoiceDetail_fd0_0_c0_babdd{
        ...
        font-size:32rpx;font-weight:500;color:var(--benbeniconColor4);
    }}}
