    ...
    <view class="top-box">
      <view
        ...
        :style="{
          ...
          height: `calc(450rpx - ${statusBarHeight}px)`,
        }"
      >
        <view class="user-info" v-if="user">
          <cach-image
            :url="user.profileUrl"
            :fileMd5="user.profileUrl"
            width="130rpx"
            height="130rpx"
            radius="50%"
          ></cach-image>
          <view class="info-box">
            ...
            <view class="phone-box">
              ...
              <image
                ...
                :src="
                  user.gender
                    ? '/static/new/man@3x.png'
                    : '/static/new/woman@3x.png'
                "
                mode=""
              ></image>
            </view>
        ...
        <view class="top-bottom-box">
          <view class="top-bottom-top">
            <view class="top-bottom-left">
              ...
              <image
                class="pet-info-arrow"
                :src="
                  darkMode == 'light'
                    ? '/static/new/icon-arrow-black.svg'
                    : '/static/new/icon-arrow-white.svg'
                "
                mode=""
              ></image>
            </view>
            <view class="top-bottom-right" @click="intoSwitch">
              <image
                class="switch-icon"
                src="/static/new/icon-switch-orange.svg"
                mode=""
              ></image>
              ...
              <view class="scroll-content">
                ...
                <view class="pet-item" @click="addpet">
                  <image
                    ...
                    :src="
                      darkMode == 'light'
                        ? '/static/imgs/add_pet/addPet.svg'
                        : '/static/new/addPet_black.svg'
                    "
                    mode=""
                  ></image>
      ...
      <view class="icon-box">
        <view class="icon-item" @click="toPersonal">
          ...
          <image
            ...
            src="/static/new/img-info-arrow.png"
            mode=""
          ></image>
        </view>
...
import { wgs84_to_gcj02 } from "/common/wgs84ToGcj02";
export default {
  data() {
    return {
      statusBarHeight: 80,
    ...
    testCat() {
      plus.geolocation.getCurrentPosition(
        function (p) {
          ...
          uni.navigateTo({
            url:
              "/pages/my/wifiSetting/catWifiSelect/catWifiSelect?paramater=" +
