<template>
  <page-body>
    <view class="page">
      <view class="flex flex-wrap align-center justify-between benben-position-layout flex loginPage_flex_0_babdd"
        :style="{height:(88+StatusBarRpx)+'rpx',paddingTop:StatusBarRpx+'rpx', }">
        <view class='flex flex-wrap align-center loginPage_fd0_0_babdd' @tap.stop="handleJumpDiy" data-type="back"
          data-url="1">
          <text class='fu-iconfont2  loginPage_fd0_0_c0_babdd'>&#xe794;</text>
        </view>
        <view class='flex flex-wrap align-center loginPage_fd0_0_babdd'>
        </view>
      ...
      <view class="flex flex-direction flex-wrap align-stretch benben-flex-layout loginPage_flex_2_babdd">
        <view class='flex flex-wrap align-center loginPage_fd2_0_babdd'>
          ...
          <benben-input class='flex-sub loginPage_fd2_0_c1_babdd' type="number" :placeholder="$t('请输入手机号')"
        ...
        <view class='flex flex-wrap align-center loginPage_fd2_1_babdd'>
          <text class='fu-iconfont2  loginPage_fd2_0_c0_babdd'>&#xe730;</text>
          <benben-flex-password-diy v-model="password" class-text="flex flex align-center loginPage_fd2_1_c1_babdd"
        ...
        <view class='flex flex-direction-row-reverse flex-wrap align-center loginPage_fd2_2_babdd'>
          <text class='loginPage_fd2_2_c0_babdd' @tap.stop="handleJumpDiy" data-type="redirectTo"
            :data-url="`/pages/dlzc/verificationCodeLogin/verificationCodeLogin`">{{$t('验证码登录')}}</text>
        </view>
        ...
        <view class='flex flex-wrap align-center justify-center loginPage_fd2_4_babdd'>
          <text class='loginPage_fd2_4_c0_babdd' @tap.stop="handleJumpDiy" data-type="navigateTo"
        ...
        <view class='flex flex-wrap align-center justify-center loginPage_fd2_5_babdd'>
          ...
          <text class='loginPage_fd2_5_c2_babdd' @tap.stop="handleJumpDiy" data-type="navigateTo"
