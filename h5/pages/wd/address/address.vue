<template>
  <page-body>
    <view class="page">
      <view
        class="flex align-stretch benben-position-layout flex address_flex_0_babdd"
      ...
      <view class="flex flex-direction align-stretch benben-flex-layout address_flex_1_babdd">
            ...
            <view class="flex flex-direction align-stretch">
              ...
              <view class="flex align-center justify-between address_fd1_0_c0_c2_babdd">
                <view class="flex flex-wrap align-center" @tap.stop="SelectDefaultFunc(item.aid, item.is_default)">
                  <text class="fu-iconfont2 address_fd1_0_c0_c2_c0_c0_babdd" v-if="item.is_default == '1'">&#xe847;</text>
                  <text class="fu-iconfont2 address_fd1_0_c0_c2_c0_c0_1_babdd" v-if="item.is_default == 0">&#xe764;</text>
                ...
                <view class="flex flex-wrap align-center">
                  ...
                  <view
                    class="flex flex-wrap align-center address_fd1_0_c0_c2_c1_c1_babdd"
        ...
        <view class="flex flex-wrap align-center justify-center address_fd1_1_babdd">
          <button class="address_fd1_1_c0_babdd" @tap.stop="handleJumpDiy" data-type="navigateTo" :data-url="`/pages/wd/editAddress/editAddress`">
            {{ $t('添加地址') }}
          </button>
        </view>
      </view>
